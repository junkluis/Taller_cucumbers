...
Característica: Buscar películas por rango

  @peliculasPorRango
  Escenario: Filtrar películas por año de estreno
     ...
     | American Psycho            | Mary Harron      | Christian Bale, Willem Dafoe, Jared Leto         | terror       | aleman                   | 2000     | NC-17     |
      Dada el usuario ingresa el rango: '1960,2005'
      Cuando busque la películas por fecha de estreno
      Entonces se encontraron 2 película(s).
  ...
  Escenario: Filtrar películas por año de estreno
     ...
     | American Psycho            | Mary Harron      | Christian Bale, Willem Dafoe, Jared Leto         | terror       | aleman                   | 2000     | NC-17     |
      ...
      Cuando busque la películas por fecha de estreno
      Entonces se encontraron 3 película(s).
      Y los título de estas películas son
      | TITULO             |
      | Ant-Man (película) |
      | Halloween          |
  ...
  Escenario: Filtrar películas por año de estreno
     ...
     | Halloween II               | John Carpenter   | Donald Pleasence, Jamie Lee Curtis, P. J. Soles  | terror       | ingles, aleman, espanol  | 1081     | R         |
     | American Psycho            | Mary Harron      | Christian Bale, Willem Dafoe, Jared Leto         | terror       | aleman                   | 2000     | NC-17     |
      Dada el usuario ingresa el rango: '2005,1960'
      Cuando busque la películas por fecha de estreno
  ...
  Escenario: Filtrar películas por año de estreno
     ...
     | Halloween II               | John Carpenter   | Donald Pleasence, Jamie Lee Curtis, P. J. Soles  | terror       | ingles, aleman, espanol  | 1081     | R         |
     | American Psycho            | Mary Harron      | Christian Bale, Willem Dafoe, Jared Leto         | terror       | aleman                   | 2000     | NC-17     |
      Dada el usuario ingresa el rango: '2016,2019'
      Cuando busque la películas por fecha de estreno
      Entonces obtiene el siguiente mensaje 'Ninguna pelicula fue estrenada durante los año 2016 y 2019'