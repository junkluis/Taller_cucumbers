...
Característica: Buscar películas por su idioma
    ...
    @peliculasPorIdioma
    Escenario: Filtrar películas que contienen en su idioma la palabra 'ingles'
    ...
    Escenario: Filtrar películas por título, sin encontrar resultado
        ...
        Dada el usuario ingresa el idioma: 'sueco'
        Cuando busque la películas por idioma
        Entonces obtendrá 0 películas que coincidan
        Y obtiene el siguiente mensaje 'No se encontró ninguna película en sueco'